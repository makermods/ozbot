...
function getWeaponTier(flameVal, base, set) {
  const tables = {
    genesis: { 406: [74, 108, 148, 195, 250], 400: [72, 106, 146, 192, 246] },
    arcane: { 406: [64, 94, 129, 170, 218], 302: [55, 80, 110, 145, 186] },
    absolab: { 103: [16, 23, 32, 42, 53], 143: [22, 32, 44, 58, 74], 150: [23, 33, 46, 60, 77] }
  };
